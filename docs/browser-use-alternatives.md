...
ours: this wiki belongs to [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp), so
...
**AIHawk** ([repo](https://github.com/feder-cr/invisible_playwright_mcp), ~30k stars, MIT) -
...
- The [Skyvern](https://github.com/Skyvern-AI/skyvern), [Agent-S](https://github.com/simular-ai/Agent-S) and [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) repositories, retrieved 2026-09-03.

---

*Written while maintaining [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp), a
