...
| [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) | ~30k | MIT | Ours: an agent bound to its own source-patched Firefox |
...
*Written by the maintainers of [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp),
