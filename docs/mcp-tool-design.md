---
title: "How the tools are shaped, and why"
description: "Why each tool of the MCP server returns what it returns: the snapshot, the coordinates, the screenshot, the JavaScript reader, and the ladder between them, with the measurements behind each decision."
