...
[AIHawk](https://github.com/feder-cr/invisible_playwright_mcp), an open-source agent in the same
...
*Kept current by the maintainers of [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp),
