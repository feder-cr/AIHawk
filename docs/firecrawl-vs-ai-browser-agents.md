...
[AIHawk](https://github.com/feder-cr/invisible_playwright_mcp), an open-source AI browser
...
*From the [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) wiki. AIHawk is an
