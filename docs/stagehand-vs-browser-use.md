...
[AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) (roughly 30k stars, MIT) is an
...
*Written while maintaining [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp),
