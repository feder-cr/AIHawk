...
[AIHawk](https://github.com/feder-cr/invisible_playwright_mcp), an open-source agent in the
...
[AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) (~30k, MIT), our own project,
...
- The [browser-use](https://github.com/browser-use/browser-use), [Skyvern](https://github.com/Skyvern-AI/skyvern), [Agent-S](https://github.com/simular-ai/Agent-S) and [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp) repositories, star counts and licenses read via the GitHub API 2026-09-03.

---

*Maintained by the team behind [AIHawk](https://github.com/feder-cr/invisible_playwright_mcp),
